...
<head>
  ...
  <title>Don Honorio Ventura State University</title>
    ...
    <div class="container" data-aos="fade-up">
      ...
      <div class="row justify-content-center" data-aos="fade-up" data-aos-delay="150">
        <div class="col-xl-6 col-lg-8">
          <h1>Visitor Tracker<span>.</span></h1>
      ...
      <div class="row gy-4 mt-5 justify-content-center" data-aos="zoom-in" data-aos-delay="250">
        <div class="col-xl-2 col-md-4">
          <div class="icon-box">
            <i class="ri-store-line">titi</i>
            <h3><a href="./superadmin/index.php"></a></h3>
          </div>
</div>
<div class="row gy-4 mt-5 justify-content-center" data-aos="zoom-in" data-aos-delay="250">
        <div class="col-xl-2 col-md-4">
          <div class="icon-box">
            <i class="ri-store-line">butu</i>
            <h3><a href="./admin/aindex.php"></a></h3>
          </div>
    </div>
  </section>
